...
public class DesktopLauncher {
    public static void main(String[] args) {
        ...
        // app
        NeonSignal app = new NeonSignal(
            "desktop", arguments.getDebug(), arguments.getLevel(), arguments.isGaDebug()
        );
    ...
    private static void setUpConfig(Lwjgl3ApplicationConfiguration config,
        ...
        if (arguments.isFullscreen()) {
            ...
            config.setWindowPosition(
                monitor.virtualX + (dm.width - width) / 2,
                monitor.virtualY + (dm.height - height) / 2
            );
