...
- **Assets** (contents of the `assets/`, `_raw/` and `_raw-big` folders) are proprietary to Dynart Kft. and may only be used for **open source and educational purposes**. Commercial use is not permitted. See [ASSETS-LICENSE.md](ASSETS-LICENSE.md) for details.
