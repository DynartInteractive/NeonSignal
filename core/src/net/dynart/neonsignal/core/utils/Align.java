...
public enum Align {
    ...
    LEFT_TOP(0, -2, 2, 0), LEFT_CENTER(0, -1, 2, 1), LEFT_BOTTOM(0, 0, 2, 2), CENTER_TOP(
        -1, -2, 1, 0
    ), CENTER(-1, -1, 1, 1), CENTER_BOTTOM(
        -1, 0, 1, 2
    ), RIGHT_TOP(-2, -2, 0, 0), RIGHT_CENTER(-2, -1, 0, 1), RIGHT_BOTTOM(-2, 0, 0, 2);
    ...
    Align(float leftMultiplier, float bottomMultiplier, float rightMultiplier,
        float topMultiplier) {
