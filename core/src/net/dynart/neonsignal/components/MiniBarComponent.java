...
public class MiniBarComponent extends Component {
    ...
    public void add(Entity entity) {
        ...
        /*
         * GameSprite sprite = new GameSprite(); sprite.setFlipEnabled(false);
         * view.addSprite(sprite); view.setSprite(viewIndex, "mini_hp_bar_bg");
         * sprite.setOffsetY(body.getHalfHeight() * 2f + 5f);
         * 
         * sprite = new GameSprite(); sprite.setFlipEnabled(false);
         * view.addSprite(sprite); view.setSprite(viewIndex + 1, "mini_hp_line");
         * sprite.setOffsetY(body.getHalfHeight() * 2f + 5f);
         * sprite.setOffsetX(-sprite.getWidth() / 2f);
         * sprite.setAlign(Align.LEFT_BOTTOM); sprite.setOrigin(0 ,0);
         * 
         * sprite = new GameSprite(); sprite.setFlipEnabled(false);
         * view.addSprite(sprite); view.setSprite(viewIndex + 2, "mini_hp_bar");
         * sprite.setOffsetY(body.getHalfHeight() * 2f + 5f);
         */
    }
    ...
    public void adjustDisplay(float value, float delta) {
        /*
         * if (visibleTime > 0) { visibleTime -= delta; if (visibleTime < 0) {
         * visibleTime = 0; } } ViewComponent view =
         * entity.getComponent(ViewComponent.class); if (dynamicColor) { if (value <
         * 0.5) { lineColor.set(DANGER_COLOR); lineColor.lerp(WARNING_COLOR, value *
         * 2f); } else { lineColor.set(WARNING_COLOR); lineColor.lerp(GOOD_COLOR, (value
         * - 0.5f) * 2f); } }
         * 
         * float alpha = visibleTime < 0.5f ? visibleTime * 2f : 1f;
         * 
         * Color c = view.getSprite(viewIndex).getColor(); c.a = alpha;
         * view.getSprite(viewIndex).setColor(c);
         * 
         * lineColor.a = alpha; view.getSprite(viewIndex + 1).setColor(lineColor);
         * view.getSprite(viewIndex + 1).setScale(value, 1);
         * 
         * c = view.getSprite(viewIndex + 2).getColor(); c.a = alpha;
